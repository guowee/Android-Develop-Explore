package com.uowee.chapter.two.provider;
...
public class BookProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.uowee.chapter.two.book.provider";
    ...
    private List<Book> mPrivateBooks = new ArrayList<>();
    ...
    private void initPrivateBooks() {
        mPrivateBooks.add(new Book(1, "ABCDEFGHIJK"));
        mPrivateBooks.add(new Book(2, "QAZXSWEDC"));
    }
